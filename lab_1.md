...
## Тема
Исследование компилятора GCC, ассемблерного кода, оптимизаций, Makefile и потоков на примере вычисления факториала.
...
- разработки модульной программы на языке C++;
- использования компилятора GCC/G++;
- генерации и анализа ассемблерного кода;
- изучения влияния оптимизаций компилятора;
- автоматизации сборки проекта с помощью Makefile;
- работы с потоками выполнения.
